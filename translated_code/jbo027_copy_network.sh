...
datafile="JDA_NETWORK_EXTRACT_$run_time"
...
echo. >> %LOG_FILE% 2>>&1
sqlplus -s $BATCH_LOGIN @$SQL_DIR/jbo027_extract_network.sql $datafile >> %LOG_FILE% 2>>&1
...
D:\java8\bin\jar -cMf $datafile.zip $datafile.dat >> %LOG_FILE