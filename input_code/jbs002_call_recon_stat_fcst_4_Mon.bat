...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_4_Mon
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_4_Mon
echo Monday Reconcile Stat4 process Completed >> %LOG_FILE% 2>>&1
)
