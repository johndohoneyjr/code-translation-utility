ECHO ON
REM ####################################################################
REM FileName:          jbs003_call_recon_promo_up_level2_Mon.bat
...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs003_recon_promo_up_level2_Mon
call %FWK_DIR%\run_process.bat jbs003_recon_promo_up_level2_Mon
