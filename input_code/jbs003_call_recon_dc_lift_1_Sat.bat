ECHO ON
REM ####################################################################
REM FileName:          jbs003_call_recon_dc_lift_1_Mon.bat
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs003_recon_dc_lift_1_Sat
call %FWK_DIR%\run_process.bat jbs003_recon_dc_lift_1_Sat
echo Saturday Reconcile DC Lift1 process Completed >> %LOG_FILE% 2>>&1
)
