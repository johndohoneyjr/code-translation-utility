ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_1_Mon.bat
...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_1_Mon
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_1_Mon
