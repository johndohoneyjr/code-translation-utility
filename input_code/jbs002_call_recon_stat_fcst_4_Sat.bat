ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_4_Mon.bat
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_4_Sat
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_4_Sat
echo Saturday Reconcile Stat4 process Completed >> %LOG_FILE% 2>>&1
)
