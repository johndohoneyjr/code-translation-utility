...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs003_recon_promo_down_level3_Mon
call %FWK_DIR%\run_process.bat jbs003_recon_promo_down_level3_Mon
echo Monday Reconcile Promo down lvl3 process Completed >> %LOG_FILE% 2>>&1
)
