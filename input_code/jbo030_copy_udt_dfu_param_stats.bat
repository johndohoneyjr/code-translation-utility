ECHO ON
REM ####################################################################
REM FileName:          jbo030_copy_udt_dfu_param_stats.bat
REM Description:       Prepare the Network Export for HD Supply
REM Note:
REM ####################################################################
...
REM --------------------------------------------------------------------
rem  2-Mar-2021    REDACTED        Initial Version
REM
REM ####################################################################
...
SET datafile=JDA_UDT_DFU_PARAM_STATS_EXTRACT_%run_time%
...
ECHO. >> %LOG_FILE% 2>>&1
CALL sqlplus -s %BATCH_LOGIN% @%SQL_DIR%\jbo030_extract_udt_dfu_param_stats.sql %datafile% >> %LOG_FILE% 2>>&1
