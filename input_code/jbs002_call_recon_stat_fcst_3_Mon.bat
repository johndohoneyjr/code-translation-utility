ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_3_Mon.bat
...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_3_Mon
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_3_Mon
echo Monday Reconcile Stat3 process Completed >> %LOG_FILE% 2>>&1
)
