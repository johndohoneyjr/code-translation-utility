...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_2_Mon
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_2_Mon
echo Monday Reconcile Stat2 process Completed >> %LOG_FILE% 2>>&1
)
