ECHO ON
REM ####################################################################
REM FileName:          jbs001_call_calculate_model_Mon.bat
REM Description:       Call Calculate Model Processes
REM Note:
REM ####################################################################
...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs001_calculate_model_Mon
call %FWK_DIR%\run_process.bat jbs001_calculate_model_Mon
