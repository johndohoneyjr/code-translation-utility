ECHO ON
REM ####################################################################
REM FileName:          jbs003_call_recon_promo_down_level1_Mon.bat
...
REM --------------------------------------------------------------------
rem  3-Mar-2020    REDACTED            Initial Version
REM
REM ####################################################################
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs003_recon_promo_down_level1_Sat
call %FWK_DIR%\run_process.bat jbs003_recon_promo_down_level1_Sat
echo Saturday Reconcile Promo down lvl1 process Completed >> %LOG_FILE% 2>>&1
)
