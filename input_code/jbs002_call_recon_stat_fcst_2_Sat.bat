ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_2_Mon.bat
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_2_Sat
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_2_Sat
echo Saturday Reconcile Stat2 process Completed >> %LOG_FILE% 2>>&1
)
