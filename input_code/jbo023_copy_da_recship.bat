ECHO ON
REM ####################################################################
REM FileName:          jbo023_copy_da_recship.bat
REM Description:       Prepare the DA Recship Export for HDS
REM Note:
REM ####################################################################
...
REM --------------------------------------------------------------------
rem  06-Mar-2019    REDACTED            Initial Version
REM
REM ####################################################################
...
SET datafile=JDA_DARECSHIP_%run_time%
...
ECHO. >> %LOG_FILE% 2>>&1
CALL sqlplus -s %BATCH_LOGIN% @%SQL_DIR%\jbo023_extract_da_recship.sql %datafile% >> %LOG_FILE% 2>>&1
