ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_5a_Mon.bat
...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_5a_Mon
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_5a_Mon
echo Monday Reconcile Stat5a process Completed >> %LOG_FILE% 2>>&1
)
