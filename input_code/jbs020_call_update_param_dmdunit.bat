ECHO ON
REM ####################################################################
REM FileName:          jbs020_call_update_param_dmdunit.bat
...
SET job_name=%XML_DIR%\jbs020_update_param_dmdunit
call %FWK_DIR%\run_process.bat jbs020_update_param_dmdunit
