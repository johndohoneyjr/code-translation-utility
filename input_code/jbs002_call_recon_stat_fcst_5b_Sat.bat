ECHO ON
REM ####################################################################
REM FileName:          jbs002_call_recon_stat_fcst_5b_Mon.bat
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs002_recon_stat_fcst_5b_Sat
call %FWK_DIR%\run_process.bat jbs002_recon_stat_fcst_5b_Sat
echo Saturday Reconcile Stat5b process Completed >> %LOG_FILE% 2>>&1
)
