...
if %DAY%==Tue ( 
SET job_name=%XML_DIR%\jbs003_recon_dc_lift_3_Mon
call %FWK_DIR%\run_process.bat jbs003_recon_dc_lift_3_Mon
echo Monday Reconcile DC Lift3 process Completed >> %LOG_FILE% 2>>&1
)
