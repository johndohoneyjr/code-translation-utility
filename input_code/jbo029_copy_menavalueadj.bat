ECHO ON
REM ####################################################################
REM FileName:          jbo029_copy_menavalueadj.bat
...
SET datafile=JDA_MEANVALUEADJ_EXTRACT_%run_time%
...
ECHO. >> %LOG_FILE% 2>>&1
CALL sqlplus -s %BATCH_LOGIN% @%SQL_DIR%\jbo029_extract_meanvalueadj.sql %datafile% >> %LOG_FILE% 2>>&1
