ECHO ON
REM ####################################################################
REM FileName:          jbs003_call_recon_promo_down_level3_Mon.bat
...
if %DAY%==Sun ( 
SET job_name=%XML_DIR%\jbs003_recon_promo_down_level3_Sat
call %FWK_DIR%\run_process.bat jbs003_recon_promo_down_level3_Sat
echo Saturday Reconcile Promo down lvl3 process Completed >> %LOG_FILE% 2>>&1
)
